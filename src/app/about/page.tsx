...
import { Calendar, MapPin, Award, BookOpen, Briefcase, Download, ExternalLink } from 'lucide-react';
...
export default function AboutPage() {
  ...
  // Filter out Mercor experience
  const filteredExperience = experience.filter(job => job.company !== 'Mercor');
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center text-gray-600">
                    ...
                    <span>Based in {contact?.location || 'Bengaluru, India'}</span>
                  </div>
                  <div className="flex items-center text-gray-600">
