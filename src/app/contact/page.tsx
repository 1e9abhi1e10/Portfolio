...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to send message. Please try again later or contact me directly at ' + contact.email);
    } finally {
      setIsSubmitting(false);
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              I am open to exploring new opportunities and meaningful engineering challenges. Whether you have a role in mind or would like to initiate a discussion, I would be happy to connect.
            </p>
          </AnimatedSection>
        </div>
      </section>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-900 font-medium">Open to opportunities</span>
                      </div>
                      <p className="text-gray-600 ml-6">
                        Open to Software Development Engineer (SDE) opportunities in organizations that value strong engineering practices, continuous learning, and long-term growth.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <span className="text-gray-900">IST (UTC+5:30)</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              I would be glad to discuss how my engineering skills and experience can contribute to building reliable, scalable software solutions.
            </p>
            <Button 
              size="lg" 
              variant="secondary"
